...
2. Alternatively, visit the [Date Converter & Calendar](/tools/date-converter) page and click **Alternative Direct ZIP Installer** to download the legacy archive (\`NepaliCalendar-Setup-v1.6.0.zip\`).
