...
export default function WidgetCalendar() {
  ...
  return (
    <div className={`fixed inset-0 z-30 flex flex-col w-full h-full font-sans overflow-hidden select-none sm:relative sm:inset-auto sm:z-auto sm:max-w-xl sm:mx-auto sm:h-[880px] sm:rounded-3xl sm:border sm:shadow-2xl transition-colors duration-200 ${
      ...
      {/* ─── DIRECT FULL-SCREEN WEBSITE VIEWER (No Reader Mode / No Safa Reader) ─── */}
      {openedNewsItem && (
        <div className="fixed inset-0 z-[100] flex flex-col w-full h-full bg-white select-none animate-fadeIn">
          {/* Reader Top Bar */}
          <div className="flex items-center justify-between px-4 py-2.5 bg-[#e52521] text-white sticky top-0 z-20 shadow-md shrink-0">
            <div className="flex items-center gap-3 min-w-0">
              ...
              <div className="min-w-0 flex-1">
                <span className="text-[10px] font-bold uppercase tracking-wider text-white/80 block">
                  {openedNewsItem.source || 'सत्यापित समाचार'}
                </span>
            ...
            <div className="flex items-center gap-2 shrink-0">
              <a
                ...
                className="px-3 py-1 bg-white text-[#e52521] rounded-full text-xs font-bold shadow hover:bg-slate-100 transition-colors flex items-center gap-1 cursor-pointer"
              >
                <span>मूल वेबसाइट</span> <ExternalLink size={12} />
              </a>
              <button
                onClick={() => setOpenedNewsItem(null)}
          ...
          {/* Full Page Raw Website Content Iframe (Zero Modifications, Untouched Site) */}
