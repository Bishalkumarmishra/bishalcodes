    ...
    try {
      ...
      if (seedTarget === 'all' || seedTarget === 'services') {
        const seeds = [
          ...
          { title: 'Word to PDF', description: 'Convert Microsoft Word documents into high-fidelity PDF documents with exact layout preservation.', iconUrl: '/pdf.svg', bgImageUrl: 'https://s.smallpdf.com/static/cms/f/102628/300x180/0cf4630611/bb46b97de13eb9b590de.svg', linkUrl: 'word-to-pdf', badge: '', order: 8 },
