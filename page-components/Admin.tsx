...
const PaymentProofViewer: React.FC<PaymentProofViewerProps> = ({ base64Image, onClose }) => {
  ...
  const DEFAULT_SEO_METADATA: Record<string, { title: string; description: string; keywords: string; canonical: string; ogImage: string }> = {
    ...
    'tools-word-to-pdf': {
      ...
      description: "Convert Microsoft Word documents to PDF files with exact margins, layout preservation, and font embedding.",
      keywords: "Word to PDF, convert docx to PDF, doc to PDF converter, online Word to PDF",
      canonical: "https://bishalcodes.com/tools/word-to-pdf",
      ogImage: "https://bishalcodes.com/seo-images/word-to-pdf.png",
    },
    'tools-excel-to-pdf': {
      title: "Excel to PDF Converter | Convert XLSX to PDF Online Free | Bishal Codes",
      description: "Convert Microsoft Excel spreadsheets to PDF files with exact layout, gridline, and chart preservation.",
      keywords: "Excel to PDF, convert xlsx to PDF, xls to PDF converter, online Excel to PDF",
      canonical: "https://bishalcodes.com/tools/excel-to-pdf",
      ogImage: "https://bishalcodes.com/seo-images/excel-to-pdf.png",
    },
    'tools-pdf-to-excel': {
      title: "PDF to Excel Converter | Extract PDF Tables to Excel Free | Bishal Codes",
      description: "Convert PDF documents to Microsoft Excel spreadsheets with structured cell rows and auto-fit columns.",
      keywords: "PDF to Excel, convert PDF to Excel, extract PDF tables, online PDF to Excel",
      canonical: "https://bishalcodes.com/tools/pdf-to-excel",
      ogImage: "https://bishalcodes.com/seo-images/pdf-to-excel.png",
    },
...
const Admin: React.FC = () => {
  ...
  const SEO_PAGES = [
    ...
    { id: 'tools-word-to-pdf', name: 'Tool: Word to PDF' },
    { id: 'tools-excel-to-pdf', name: 'Tool: Excel to PDF' },
    { id: 'tools-pdf-to-excel', name: 'Tool: PDF to Excel' },
    ...
    try {
      ...
      if (seedTarget === 'all' || seedTarget === 'services') {
        const seeds = [
          ...
          { title: 'PDF to Word', description: 'Convert PDF documents into fully editable Microsoft Word DOCX documents with maximum precision. Runs entirely offline in your browser.', iconUrl: '/pdf to word.svg', bgImageUrl: 'https://s.smallpdf.com/static/cms/f/102628/300x180/0cf4630611/bb46b97de13eb9b590de.svg', linkUrl: 'pdf-to-word', badge: '', order: 8 },
          { title: 'Word to PDF', description: 'Convert Microsoft Word documents into high-fidelity PDF documents with exact layout preservation.', iconUrl: '/word to pdf.svg', bgImageUrl: 'https://s.smallpdf.com/static/cms/f/102628/300x180/0cf4630611/bb46b97de13eb9b590de.svg', linkUrl: 'word-to-pdf', badge: '', order: 8 },
          { title: 'Excel to PDF', description: 'Convert Excel spreadsheets into high-fidelity PDF documents with exact layout preservation.', iconUrl: '/currancy converter.svg', bgImageUrl: 'https://s.smallpdf.com/static/cms/f/102628/300x180/0cf4630611/bb46b97de13eb9b590de.svg', linkUrl: 'excel-to-pdf', badge: '', order: 8 },
          { title: 'PDF to Excel', description: 'Extract tables and text from PDF documents into fully formatted Excel spreadsheets.', iconUrl: '/currancy converter.svg', bgImageUrl: 'https://s.smallpdf.com/static/cms/f/102628/300x180/0cf4630611/bb46b97de13eb9b590de.svg', linkUrl: 'pdf-to-excel', badge: '', order: 8 },
