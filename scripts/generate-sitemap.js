...
async function run() {
  ...
  const staticPages = [
    ...
    { path: '/developers/screenshot', priority: '0.8', changefreq: 'weekly' },
    { path: '/developers/qrcode', priority: '0.8', changefreq: 'weekly' },
    { path: '/developers/ocr', priority: '0.8', changefreq: 'weekly' },
    { path: '/developers/summarize', priority: '0.8', changefreq: 'weekly' },
    { path: '/developers/diff', priority: '0.8', changefreq: 'weekly' },
    { path: '/developers/json-format', priority: '0.8', changefreq: 'weekly' },
