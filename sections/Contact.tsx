        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-16">
          <div className="w-full lg:w-1/2 flex flex-col justify-center">
            <div className="flex items-center gap-2 mb-3">
              <p className="text-slate-900 dark:text-white font-semibold text-xs uppercase tracking-wider">Contact</p>
            </div>
            <h2 className="text-slate-900 text-3xl sm:text-4xl font-bold tracking-tight mb-4">Get in Touch</h2>
            <p className="text-slate-600 text-base sm:text-lg font-normal leading-relaxed mb-8 max-w-lg">If you have a project idea, business inquiry, or technical question, feel free to send a message or reach out via WhatsApp.</p>
